      ...
      {CATEGORY_BLOCKS.map((block, i) => (
        ...
        >
          ...
          <div className="absolute bottom-0 left-0 right-0 p-4">
            <h3 className="text-white text-lg md:text-xl font-black uppercase tracking-tight leading-none group-hover:text-[#ffff00] transition-colors">
              {block.title}
            </h3>
            <div className="h-1 w-8 bg-white mt-3 group-hover:bg-[#ffff00] group-hover:w-16 transition-all duration-300" />
          </div>
        </Link>
      ))}
    </div>
